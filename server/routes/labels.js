...
export default (app) => {
  app
    .get(
      '/labels',
      { name: 'labels#index', preValidation: app.authenticate },
      async (req, reply) => {
    ...
    .get(
      '/labels/:id/edit',
      { name: 'labels#edit', preValidation: app.authenticate },
      async (req, reply) => {
    ...
    .post(
      '/labels',
      { name: 'labels#create', preValidation: app.authenticate },
      async (req, reply) => {
    ...
    .patch(
      '/labels:id',
      { name: 'labels#update', preValidation: app.authenticate },
      async (req, reply) => {
        const label = await app.objection.models.label
          .query()
          .findById(req.params.id);
    ...
    .delete(
      '/labels/:id',
      { name: 'labels#destroy', preValidation: app.authenticate },
      async (req, reply) => {
        try {
